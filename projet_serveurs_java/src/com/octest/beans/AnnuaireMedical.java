...
public class AnnuaireMedical {
	private String centre_medical;
	private String medecin_email;
	private String specialite;
	
	public AnnuaireMedical(String centre_medical, String medecin_email, String specialite) {
	...
	public boolean equals(Object obj) {
		if(obj instanceof AnnuaireMedical) {
			AnnuaireMedical annuaire = (AnnuaireMedical) obj;
