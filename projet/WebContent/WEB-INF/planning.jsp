...
@media (max-width:450px) {
  ...
  <body>
              ...
              <div class="calendar-header">
                ...
                <div class="row header-title">
                  ...
                  <div class="header-text">
                    ...
                    <h5 id="todayDayName"><c:out value="${ medecin }" />Today is Friday 7 Feb</h5>
                  </div>
    ...
    */
    ...
    //   alert(parseInt(e.target.innerHTML));
    //   alert(currentDate.getMonth());
    //   alert(currentDate.getFullYear());
    //   alert(selectedDate);
       
       var jj=e.target.innerHTML;
       if(parseInt(jj)<10){
    	   jj="0"+jj;
       }
  ...
  //     alert(aaaa);
       ...
       var format_date = aaaa+"-"+mm+"-"+jj;
       
       alert(format_date);
       
       $(document).on("click", "#envoyer", function() {
       	$.post("planning",{"param1":format_date},function(data){alert("Hello");},"json");
       });
